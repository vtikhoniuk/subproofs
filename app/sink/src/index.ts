...
const SUBSTREAM = url.fileURLToPath(new URL("../../../substreams.yaml", import.meta.url));
...
const request = createRequest({
  ...
  startBlockNum: 10000001,
  stopBlockNum: "+1", // Stream the first 10000 blocks. Will follow chain head if not set.
});
